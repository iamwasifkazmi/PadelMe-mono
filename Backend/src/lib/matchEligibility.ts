...
export type MatchEligibilityProfile = {
  email: string;
...
export function userToEligibilityProfile(user: User): MatchEligibilityProfile {
  return {
    email: user.email,
...
export function stubProfileForEmail(email: string): MatchEligibilityProfile {
  return {
    email,
 ...
 */
export function playerMeetsMatchEligibility(
  match: Match,
  player: MatchEligibilityProfile,
...
export function validateRosterEligibility(
  match: Match,
  profilesByEmail: Map<string, MatchEligibilityProfile>,
