...
export async function generateLeagueWeekFixtures(
  league: Competition,
  weekNumber?: number,
...
export async function runWeeklyLeagueFixtureGeneration(): Promise<
  Array<{ leagueId: string; action: string; week?: number; matches?: number; reason?: string }>
> {
