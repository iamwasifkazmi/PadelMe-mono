import { effectiveTeamsAtStart, isDoublesStyle, teamsPartitionPlayers, } from "./matchTeams.js";
import { validateRosterEligibility, } from "./matchEligibility.js";
...
export function validateMatchStructure(match) {
...
export function validateMatchStart(match, rosterProfiles) {
